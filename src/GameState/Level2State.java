...
//        }
        if (MenuState.allowDownload == false) {
            ...
            tileMap.loadMap("/Maps/lal.map");

            tileMap.setPosition(0, 0);
            tileMap.setTween(1);
            bg = new Background("/Backgrounds/pink.gif", 0.1);
            ...
            this.hero.setPosition(1, 200);//1930
    ...
    public void update() {
        ...
        if (hero.getHealth() == 0 || hero.gety() > 500) {
            eventDead = true;
        }
        if (eventStart) {
            eventStart();
        ...
        if (hero.getx() > 836) {
            // tileMap.setTile(7, 27, 34);
            tileMap.setTile(7, 28, 34);
            tileMap.setTile(8, 28, 34);
            tileMap.setTile(8, 29, 34);
        }
        if (hero.getx() > 1233) {
            tileMap.setTile(10, 44, 34);
            tileMap.setTile(10, 45, 34);
            tileMap.setTile(10, 46, 34);
        }
